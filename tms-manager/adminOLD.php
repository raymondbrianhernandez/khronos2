...
<div>
    ...
    if( isset( $_POST['get_weeks'] ) ) {
        ...
        echo "SELECT `date` FROM `songs` WHERE `select_week` = $selected_week";
        ...
        echo "<center><h4>FFor the week of " . $selected_week . "</h4></center><hr>";
        ...
        echo "<tr>";
        echo "<td style='width: 33.33%;'><b>Opening Song</b></td>";
        echo "<td style='width: 33.33%;'><b>Middle Song</b></td>";
        echo "<td style='width: 33.33%;'><b>Closing Song</b></td>";
        echo "</tr>";
        while ( $row = mysqli_fetch_array ( $songs ) ) {
            ...
            echo "<td style='width: 33.33%;'>" . $row['song_open'] . "</td>";
            echo "<td style='width: 33.33%;'>" . $row['song_mid'] . "</td>";
            echo "<td style='width: 33.33%;'>" . $row['song_close'] . "</td>";
            echo "</tr>";
        }
