...
<?php
    // index.php will be simple, as it only displays 
    // the revision histories then jump to login page.  
    // No other codes will be posted here.

    // Now let's go to login page...
    // header("Location: https://khronos.pro/public/login.php"); 
