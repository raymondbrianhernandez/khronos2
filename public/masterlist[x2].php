...
<?php
    ...
    $query = 'SELECT @i:=@i+1 AS num, master_territory.* FROM master_territory, (SELECT @i:=0) i WHERE owner="'.$congregation. '" ORDER BY Address_ID DESC LIMIT ?,?';
    ...
    // Pagination
    $total_pages = $con->query('SELECT COUNT(status) FROM master_territory WHERE owner='.'"'.$congregation.'"')->fetch_row()[0];
    ...
    $gps_query = "SELECT latitude, longitude FROM master_territory WHERE owner='".$congregation."'";
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 col-xl-6 text-center mx-auto">
                            <h2 style="color:black"> Master Territory for <?= $_SESSION['congregation'] ?> Congregation </h2>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex justify-content-center" id=search>
                        ...
                        <hr>
                        <table id="address-table" class="table table-bordered table-responsive-sm table-hover">
                            <tr id="column-header">
                                <th> #         </th>
                                <th> STATUS    </th>
                                <th> NAME      </th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center; width:1px;"> 
                                    <?php echo $row['num'] + ($page-1) * $num_results_on_page; ?>
                                </td>
                                <td style="text-align:center; width:1px;">
                                    <b>
                                ...
                                <td style="text-align:center; width:100px;">
                                    <button id="editbutton" data-toggle="toggle" style="background-color:green;"> Edit </button>
                            ...
                            <tr class="hideTr">
                                <form action="edit.php" method="post">
                                    ...
                                    <td style="text-align:center;">
                                        ...
                                        <button id="deletebutton" type="submit" formaction="delete.php" onclick="return confirm('Are you sure you want to delete this entry?');">
                                            Delete
                                        </button>   
                                    </td>
                                </form>
